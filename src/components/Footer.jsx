...
const FooterIconLink = ({ href, label, icon: Icon }) => {
  ...
  return (
    <li className="inline-block px-2">
      <a
        {...linkParams}
        className="inline-flex h-8 w-8 border border-indigo-800 text-indigo-800 rounded-full items-center justify-center transition-colors duration-200 hover:text-white hover:bg-indigo-400 hover:border-indigo-400"
      >
